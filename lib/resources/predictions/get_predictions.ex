defmodule TwitchApi.Predictions.GetPredictions do
  ...
  @typep broadcaster_id :: %{required(:broadcaster_id) => String.t()} # The broadcaster running Predictions. Provided broadcaster_id must match the user_id in the user OAuth token.Maximum: 1
