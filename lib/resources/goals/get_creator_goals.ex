defmodule TwitchApi.Goals.GetCreatorGoals do
  ...
  @typep broadcaster_id :: %{required(:broadcaster_id) => String.t()} # The ID of the broadcaster that created the goals.
  
  @spec call(broadcaster_id) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{broadcaster_id: broadcaster_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/goals?broadcaster_id=#{broadcaster_id}",
