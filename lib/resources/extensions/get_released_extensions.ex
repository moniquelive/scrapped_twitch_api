defmodule TwitchApi.Extensions.GetReleasedExtensions do
  ...
  @spec call(extension_id | extension_version) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{extension_id: extension_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/extensions/released?extension_id=#{extension_id}",
    Headers.config_headers(), nil)
  end

  def call(%{extension_version: extension_version}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/extensions/released?extension_version=#{extension_version}",
    Headers.config_headers(), nil)
  end
