defmodule TwitchApi.Extensions.GetExtensions do
  ...
  @typep extension_id :: %{required(:extension_id) => String.t()} # ID of the Extension.
  
  @spec call(extension_id) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{extension_id: extension_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/extensions?extension_id=#{extension_id}",
