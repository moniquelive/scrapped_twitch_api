defmodule TwitchApi.Search.SearchChannels do
  ...
  @spec call(query | first | after_query_param | live_only) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  ...
  def call(%{first: first}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/search/channels?first=#{first}",
    Headers.config_headers(), nil)
  end

  def call(%{after: after_query_param}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/search/channels?after=#{after_query_param}",
    Headers.config_headers(), nil)
  end

  def call(%{live_only: live_only}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/search/channels?live_only=#{live_only}",
    Headers.config_headers(), nil)
  end
