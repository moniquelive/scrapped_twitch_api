defmodule TwitchApi.Search.SearchCategories do
  ...
  @spec call(query | first | after_query_param) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  ...
  def call(%{first: first}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/search/categories?first=#{first}",
    Headers.config_headers(), nil)
  end

  def call(%{after: after_query_param}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/search/categories?after=#{after_query_param}",
    Headers.config_headers(), nil)
  end
