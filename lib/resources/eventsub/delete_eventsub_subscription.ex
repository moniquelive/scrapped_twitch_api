defmodule TwitchApi.EventSub.DeleteEventSubSubscription do
  ...
  @typep id :: %{required(:id) => String.t()} # The ID of the subscription to delete. This is the ID that Create Eventsub Subscription returns.
  
  @spec call(id) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{id: id}) do
    MyFinch.request("DELETE","https://api.twitch.tv/helix/eventsub/subscriptions?id=#{id}",
