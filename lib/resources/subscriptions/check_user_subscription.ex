defmodule TwitchApi.Subscriptions.CheckUserSubscription do
  ...
  @typep broadcaster_id :: %{required(:broadcaster_id) => String.t()} # User ID of an Affiliate or Partner broadcaster.
  @typep user_id :: %{required(:user_id) => String.t()} # User ID of a Twitch viewer.
  
  @spec call(broadcaster_id | user_id) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{broadcaster_id: broadcaster_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/subscriptions/user?broadcaster_id=#{broadcaster_id}",
    TwitchApi.ApiJson.Template.Method.Headers.config_headers(), nil)
  end

  def call(%{user_id: user_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/subscriptions/user?user_id=#{user_id}",
    TwitchApi.ApiJson.Template.Method.Headers.config_headers(), nil)
  end
