defmodule TwitchApi.Subscriptions.GetBroadcasterSubscriptions do
  ...
  @spec call(broadcaster_id | user_id | after_query_param | first) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  ...
  def call(%{user_id: user_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/subscriptions?user_id=#{user_id}",
    Headers.config_headers(), nil)
  end

  def call(%{after: after_query_param}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/subscriptions?after=#{after_query_param}",
    Headers.config_headers(), nil)
  end

  def call(%{first: first}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/subscriptions?first=#{first}",
    Headers.config_headers(), nil)
  end
