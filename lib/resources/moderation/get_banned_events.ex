defmodule TwitchApi.Moderation.GetBannedEvents do
  ...
  def call(%{user_id: user_id}, user_info) do
    MyFinch.request("GET","https://api.twitch.tv/helix/moderation/banned/events?user_id=#{user_id}",
    Headers.config_oauth_headers(user_info), nil)
  end

  def call(%{after: after_query_param}, user_info) do
    MyFinch.request("GET","https://api.twitch.tv/helix/moderation/banned/events?after=#{after_query_param}",
    Headers.config_oauth_headers(user_info), nil)
  end

  def call(%{first: first}, user_info) do
    MyFinch.request("GET","https://api.twitch.tv/helix/moderation/banned/events?first=#{first}",
    Headers.config_oauth_headers(user_info), nil)
  end
