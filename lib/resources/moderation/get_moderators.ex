defmodule TwitchApi.Moderation.GetModerators do
  ...
  @spec call(broadcaster_id | user_id | first | after_query_param, user_info) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  ...
  def call(%{user_id: user_id}, user_info) do
    MyFinch.request("GET","https://api.twitch.tv/helix/moderation/moderators?user_id=#{user_id}",
    Headers.config_oauth_headers(user_info), nil)
  end

  def call(%{first: first}, user_info) do
    MyFinch.request("GET","https://api.twitch.tv/helix/moderation/moderators?first=#{first}",
    Headers.config_oauth_headers(user_info), nil)
  end

  def call(%{after: after_query_param}, user_info) do
    MyFinch.request("GET","https://api.twitch.tv/helix/moderation/moderators?after=#{after_query_param}",
    Headers.config_oauth_headers(user_info), nil)
  end
