defmodule TwitchApi.Chat.GetChannelChatBadges do
  ...
  @typep broadcaster_id :: %{required(:broadcaster_id) => String.t()} # The broadcaster whose chat badges are being requested. Provided broadcaster_id must match the user_id in the user OAuth token.Maximum: 1
  
  @spec call(broadcaster_id) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{broadcaster_id: broadcaster_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/chat/badges?broadcaster_id=#{broadcaster_id}",
