defmodule TwitchApi.Entitlements.GetDropsEntitlements do
  ...
  @spec call(id | user_id | game_id | fulfillment_status | after_query_param | first) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{id: id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/entitlements/drops?id=#{id}",
    Headers.config_headers(), nil)
  end

  def call(%{user_id: user_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/entitlements/drops?user_id=#{user_id}",
    Headers.config_headers(), nil)
  end

  def call(%{game_id: game_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/entitlements/drops?game_id=#{game_id}",
    Headers.config_headers(), nil)
  end

  def call(%{fulfillment_status: fulfillment_status}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/entitlements/drops?fulfillment_status=#{fulfillment_status}",
    Headers.config_headers(), nil)
  end

  def call(%{after: after_query_param}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/entitlements/drops?after=#{after_query_param}",
    Headers.config_headers(), nil)
  end

  def call(%{first: first}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/entitlements/drops?first=#{first}",
    Headers.config_headers(), nil)
  end
