defmodule TwitchApi.Bits.GetExtensionTransactions do
  ...
  @spec call(extension_id | id | after_query_param | first) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  ...
  def call(%{id: id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/extensions/transactions?id=#{id}",
    Headers.config_headers(), nil)
  end

  def call(%{after: after_query_param}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/extensions/transactions?after=#{after_query_param}",
    Headers.config_headers(), nil)
  end

  def call(%{first: first}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/extensions/transactions?first=#{first}",
    Headers.config_headers(), nil)
  end
