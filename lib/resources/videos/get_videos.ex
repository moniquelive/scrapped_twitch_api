defmodule TwitchApi.Videos.GetVideos do
  ...
  @spec call(id | user_id | game_id | after_query_param | before | first | language | period | sort | type) :: {:ok, Finch.Response.t} | {:error, Exception.t}
  def call(%{id: id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?id=#{id}",
    Headers.config_headers(), nil)
  end

  def call(%{user_id: user_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?user_id=#{user_id}",
    Headers.config_headers(), nil)
  end

  def call(%{game_id: game_id}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?game_id=#{game_id}",
    Headers.config_headers(), nil)
  end

  def call(%{after: after_query_param}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?after=#{after_query_param}",
    Headers.config_headers(), nil)
  end

  def call(%{before: before}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?before=#{before}",
    Headers.config_headers(), nil)
  end

  def call(%{first: first}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?first=#{first}",
    Headers.config_headers(), nil)
  end

  def call(%{language: language}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?language=#{language}",
    Headers.config_headers(), nil)
  end

  def call(%{period: period}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?period=#{period}",
    Headers.config_headers(), nil)
  end

  def call(%{sort: sort}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?sort=#{sort}",
    Headers.config_headers(), nil)
  end

  def call(%{type: type}) do
    MyFinch.request("GET","https://api.twitch.tv/helix/videos?type=#{type}",
    Headers.config_headers(), nil)
  end
