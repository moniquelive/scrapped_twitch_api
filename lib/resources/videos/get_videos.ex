defmodule TwitchApi.Videos.GetVideos do
  ...
  @typep id :: %{required(:id) => String.t()} # ID of the video being queried. Limit: 100. If this is specified, you cannot use any of the optional query parameters below.
  @typep user_id :: %{required(:user_id) => String.t()} # ID of the user who owns the video. Limit 1.
  @typep game_id :: %{required(:game_id) => String.t()} # ID of the game the video is of. Limit 1.
